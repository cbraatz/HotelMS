...
/*
 * FrmMotivoDescarte.java
 *
 * Created on 17-ene-2011, 13:21:11
 */
 ...
 * @author hp dv7
 */
public class FrmMotivoDescarte extends javax.swing.JDialog {

    /** Creates new form FrmMotivoDescarte */
    public FrmMotivoDescarte(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Motivo de descarte");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 153)), "Datos del motivo de descarte", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 153))); // NOI18N
        ...
        jTextField1.setToolTipText("CÓDIGO DEL MOTIVO DE DESCARTE");
        ...
        jTextField2.setToolTipText("DESCRIPCIÓN DEL MOTIVO DE DESCARTE");
    ...
    //para el navegador de busqueda//
        ...
        Motivodesc mot=new Motivodesc();
        MotivoDescGest motges=new MotivoDescGest();  //instanciamos las clases necesarias a lo largo del programa
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(milista.isEmpty()==false){  //si no esta vacia la lista, es decir si hay algun registro en la tabla
            contador=1;
            mot=(Motivodesc) (milista.get(contador-1));
            jTextField1.setText(Integer.toString(mot.getIdmotivo()));
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        ...
        if(jTextField1.getText().isEmpty()==false){
            encontrado=motges.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
            if(encontrado){
                this.mot=motges.GetObjMotivodesc();
                jTextField1.setText(Integer.toString(mot.getIdmotivo()));
                jTextField2.setText(mot.getDescdesc());
            } else {
        ...
        if(jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty()){ //si el campo id o descripcion estan vacios
            ...
            if (encontrado){  //si se encontro y se desea EDITAR
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    // try {
                    //si se presiono SI
                    mo=motges.GetObjMotivodesc();
                    mo.setDescdesc(jTextField2.getText().toUpperCase());
                    resu=motges.editMotivodesc(mo);
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    //  try {
                    mo.setIdmotivo(Integer.parseInt(jTextField1.getText()));
                    mo.setDescdesc(jTextField2.getText().toUpperCase());
                    resu=motges.addMotivodesc(mo);
                    if (resu){
            ...
            if (x==1){  //si se llevo a cabo algun cambio
                ...
                consulta=Sesion.createQuery("from Motivodesc order by descdesc");
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        if (encontrado && jTextField1.getText().isEmpty()==false){
            ...
            if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                //  try {
                if (descges.ExisteFKMotivoDesc(Integer.parseInt(jTextField1.getText()))==false){  //si no esta como FK en ninguna de las tablas
                    Motivodesc mo=new Motivodesc();
                    mo=motges.GetObjMotivodesc();
                    resu=motges.delMotivodesc(mo);
                    if (resu){  //SI SE borro
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmMotivoDescarte dialog = new FrmMotivoDescarte(new javax.swing.JFrame(), true);
