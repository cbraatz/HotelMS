...
public class FrmIva extends javax.swing.JDialog {

    /** Creates new form FrmIva */
    public FrmIva(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 153)), "Datos del Impuesto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 153))); // NOI18N
        ...
        jLabel2.setText("Aplicado a:");

        jTextField1.setBackground(new java.awt.Color(153, 153, 255));
        jTextField1.setForeground(new java.awt.Color(255, 255, 255));
        jTextField1.setToolTipText("CÓDIGO DEL IMPUESTO");
        ...
        jTextField3.setToolTipText("PORCENTAJE QUE GRAVA ESTE IMPUESTO");
        ...
        Iva iva=new Iva();
        VariosGest varges=new VariosGest();  //instanciamos las clases necesarias a lo largo del programa
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(milista.isEmpty()==false){  //si no esta vacia la lista, es decir si hay algun registro en la tabla
            contador=1;
            iva=(Iva) (milista.get(contador-1));
            jTextField1.setText(Integer.toString(iva.getIdiva()));
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        ...
        if(jTextField1.getText().isEmpty()==false){
            encontrado=ivages.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
            if(encontrado){
                this.iva=ivages.GetObjIva();
                jTextField1.setText(Integer.toString(iva.getIdiva()));
                jTextField2.setText(iva.getDesciva());
                jTextField3.setText(Float.toString(iva.getPorc()));
            } else {
    ...
    private void jTextField3FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField3FocusLost
        ...
        if(jTextField3.getText().isEmpty()==false){   //si no esta vacio
            try{
                ...
                if(fl>=100){
                    JOptionPane.showMessageDialog(null,"Número demasiado alto","ATENCIÓN",JOptionPane.INFORMATION_MESSAGE);
                    jTextField3.setText("0.0");
                    jTextField3.requestFocus();
                }
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        if(jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || Float.parseFloat(jTextField3.getText())==0){ //si el campo id o descripcion estan vacios
            ...
            boolean existeporcentaje=ivages.ExistePorcentajeEnTabla(Float.parseFloat(jTextField3.getText()));
            encontrado=ivages.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
            int r=0;
            boolean resu=false;
            if(existeporcentaje==false){
                if (encontrado){  //si se encontro y se desea EDITAR
                    ...
                    if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                        ...
                        //si se presiono SI
                        ii=ivages.GetObjIva();
                        ii.setDesciva(jTextField2.getText().toUpperCase());
                        ii.setPorc(Float.parseFloat(jTextField3.getText()));
                        resu=ivages.editIva(ii);
                    ...
                    if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                        //  try {
                        ii.setIdiva(Integer.parseInt(jTextField1.getText()));
                        ii.setDesciva(jTextField2.getText().toUpperCase());
                        ii.setPorc(Float.parseFloat(jTextField3.getText()));
                        resu=ivages.addIva(ii);
                        if (resu){
                ...
                if (x==1){  //si se llevo a cabo algun cambio
                    ...
                    consulta=Sesion.createQuery("from Iva");
                    milista=consulta.list();
                    Sesion.getTransaction().commit();
                }
                ///////////////////////////////////////////////////////////////*/
            }else
                JOptionPane.showMessageDialog(null,"Este porcentaje de IVA ya fue cargado, si desea puede editarlo en lugar de cargar uno nuevo","AVISO",JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        if (encontrado && jTextField1.getText().isEmpty()==false){
            ...
            if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                //  try {
                if (varges.ExisteFKIva(Integer.parseInt(jTextField1.getText()))==false && stoges.ExisteFKIva(Integer.parseInt(jTextField1.getText()))==false){  //si no esta como FK en ninguna de las tablas
                    Iva ii=new Iva();
                    ii=ivages.GetObjIva();
                    resu=ivages.delIva(ii);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmIva dialog = new FrmIva(new javax.swing.JFrame(), true);
