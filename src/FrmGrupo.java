...
public class FrmGrupo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Grupo de habitaciones");
        ...
        jTextField1.setToolTipText("CÓDIGO DEL GRUPO DE HABITACIONES");
        ...
        jTextField2.setToolTipText("DESCRIPCIÓN DEL GRUPO DE HABITACIONES");
        ...
        Grupo gru=new Grupo();  //instanciamos las clases necesarias a lo largo del programa
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(milista.isEmpty()==false){  //si no esta vacia la lista, es decir si hay algun registro en la tabla
            contador=1;
            gru=(Grupo) (milista.get(contador-1));
            jTextField1.setText(Integer.toString(gru.getIdgrupo()));
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        ...
        if(jTextField1.getText().isEmpty()==false){
            encontrado=gruges.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
            if(encontrado){
                this.gru=gruges.GetObjGrupo();
                jTextField1.setText(Integer.toString(gru.getIdgrupo()));
                jTextField2.setText(gru.getDescripgru());
            } else {
           ...
           JOptionPane.showMessageDialog(null,"Campos clave vacíos","ATENCIÓN",JOptionPane.INFORMATION_MESSAGE);
            ...
            if (encontrado){  //si se encontro y se desea EDITAR
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    // try {
                    //si se presiono SI
                    gr=gruges.GetObjGrupo();
                    gr.setDescripgru(jTextField2.getText().toUpperCase());
                    resu=gruges.editGrupo(gr);
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    //  try {
                    gr.setIdgrupo(Integer.parseInt(jTextField1.getText()));
                    gr.setDescripgru(jTextField2.getText().toUpperCase());
                    resu=gruges.addGrupo(gr);
                    if (resu){
            ...
            if (x==1){  //si se llevo a cabo algun cambio
                ...
                consulta=Sesion.createQuery("from Grupo order by descripgru");
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        if (encontrado && jTextField1.getText().isEmpty()==false){
            ...
            if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                //  try {
                if (habges.ExisteFKGrupo(Integer.parseInt(jTextField1.getText()))==false){  //si no esta como FK en ninguna de las tablas
                    Grupo gr=new Grupo();
                    gr=gruges.GetObjGrupo();
                    resu=gruges.delGrupo(gr);
                    if (resu){  //SI SE EDITO CORRECTAMENTE
