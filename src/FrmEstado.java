...
public class FrmEstado extends javax.swing.JDialog {

    /** Creates new form FrmEstado */
    public FrmEstado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Estado de las habitaciones");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 153)), "Datos del Estado de las habitaciones", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 153))); // NOI18N
        ...
        jTextField1.setToolTipText("CÓDIGO DEL ESTADO");
        ...
        jTextField2.setToolTipText("DESCRIPCIÓN DEL ESTADO");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(milista.isEmpty()==false){  //si no esta vacia la lista, es decir si hay algun registro en la tabla
            contador=1;
            est=(Estado) (milista.get(contador-1));
            jTextField1.setText(Integer.toString(est.getIdestado()));
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        ...
        if(jTextField1.getText().isEmpty()==false){
            encontrado=estges.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
            if(encontrado){
                this.est=estges.GetObjEstado();
                jTextField1.setText(Integer.toString(est.getIdestado()));
                jTextField2.setText(est.getDescripest());
            } else {
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        if(jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty()){ //si el campo id o descripcion estan vacios
           JOptionPane.showMessageDialog(null,"Campos clave vacíos","ATENCIÓN",JOptionPane.INFORMATION_MESSAGE);
            ...
            if(Integer.parseInt(this.jTextField1.getText())>5){
                encontrado=estges.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
                int r=0;
                boolean resu=false;
                if (encontrado){  //si se encontro y se desea EDITAR
                    ...
                    if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                        // try {
                        //si se presiono SI
                        esta=estges.GetObjEstado();
                        esta.setDescripest(jTextField2.getText().toUpperCase());
                        resu=estges.editEstado(esta);
                    ...
                    if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                        //  try {
                        esta.setIdestado(Integer.parseInt(jTextField1.getText()));
                        esta.setDescripest(jTextField2.getText().toUpperCase());
                        resu=estges.addEstado(esta);
                        if (resu){
                ...
                if (x==1){  //si se llevo a cabo algun cambio
                    ...
                    consulta=Sesion.createQuery("from Estado order by descripest");
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        if (encontrado && jTextField1.getText().isEmpty()==false){
            if(Integer.parseInt(this.jTextField1.getText())>5){
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    //  try {
                    if (habges.ExisteFKEstado(Integer.parseInt(jTextField1.getText()))==false && ocuges.ExisteFKEstado(Integer.parseInt(jTextField1.getText()))==false){  //si no esta como FK en ninguna de las tablas
                        Estado esta=new Estado();
                        esta=estges.GetObjEstado();
                        resu=estges.delEstado(esta);
                        if (resu){  //SI SE EDITO CORRECTAMENTE
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmEstado dialog = new FrmEstado(new javax.swing.JFrame(), true);
