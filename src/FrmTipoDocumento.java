...
public class FrmTipoDocumento extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 153)), "Datos de Tipo de Documento", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 153))); // NOI18N
        ...
        jTextField1.setToolTipText("CÓDIGO DEL TIPO DE DOCUMENTO");
        ...
        jTextField2.setToolTipText("DESCRIPCIÓN DEL TIPO DE DOCUMENTO");
    ...
    //para el navegador de busqueda//
        ...
        TipoDocumentoGest tipodocges=new TipoDocumentoGest();  //instanciamos las clases necesarias a lo largo del programa
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(milista.isEmpty()==false){  //si no esta vacia la lista, es decir si hay algun registro en la tabla
            contador=1;
            tipodoc=(Tipodocumento) (milista.get(contador-1));
            jTextField1.setText(Integer.toString(tipodoc.getIdtipodoc()));
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        ...
        if(jTextField1.getText().isEmpty()==false){
            encontrado=tipodocges.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
            if(encontrado){
                this.tipodoc=tipodocges.GetObjTipodocumento();
                jTextField1.setText(Integer.toString(tipodoc.getIdtipodoc()));
                jTextField2.setText(tipodoc.getDescriptipodoc());
            } else {
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        ...
        c=tipodocges.getsiguientecodigo();
        LimpiarCampos();
        if (c>0){
           ...
           JOptionPane.showMessageDialog(null,"Campos clave vacíos","ATENCIÓN",JOptionPane.INFORMATION_MESSAGE);
            ...
            if (encontrado){  //si se encontro y se desea EDITAR
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    // try {
                    //si se presiono SI
                    td=tipodocges.GetObjTipodocumento();
                    td.setDescriptipodoc(jTextField2.getText().toUpperCase());
                    resu=tipodocges.editTipodocumento(td);
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    //  try {
                    td.setIdtipodoc(Integer.parseInt(jTextField1.getText()));
                    td.setDescriptipodoc(jTextField2.getText().toUpperCase());
                    resu=tipodocges.addTipodocumento(td);
                    if (resu){
            ...
            if (x==1){  //si se llevo a cabo algun cambio
                ...
                consulta=Sesion.createQuery("from Tipodocumento order by descriptipodoc");
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        if (encontrado && jTextField1.getText().isEmpty()==false){
            ...
            if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                //  try {
                if (clieges.ExisteFKTipoDocumento(Integer.parseInt(jTextField1.getText()))==false){  //si no esta como FK en ninguna de las tablas
                    Tipodocumento td=new Tipodocumento();
                    td=tipodocges.GetObjTipodocumento();
                    resu=tipodocges.delTipodocumento(td);
                    if (resu){  //SI SE BORRO
