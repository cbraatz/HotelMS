...
public class FrmProfesion extends javax.swing.JDialog {

    /** Creates new form FrmProfesion */
    public FrmProfesion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 153)), "Datos de la Profesión", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 153))); // NOI18N
        ...
        jTextField1.setToolTipText("CÓDIGO DE LA PROFESIÓN");
        ...
        jTextField2.setToolTipText("NOMBRE DE LA PROFESIÓN");
    ...
    //para el navegador de busqueda//
        ...
        ProfesionGest profges=new ProfesionGest();  //instanciamos las clases necesarias a lo largo del programa
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        ...
        if(jTextField1.getText().isEmpty()==false){
            encontrado=profges.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
            if(encontrado){
                this.profesion=profges.GetObjProfesion();
                jTextField1.setText(Integer.toString(profesion.getIdprof()));
                jTextField2.setText(profesion.getDescripprof());
            } else {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(milista.isEmpty()==false){  //si no esta vacia la lista, es decir si hay algun registro en la tabla
            contador=1;
            profesion=(Profesion) (milista.get(contador-1));
            jTextField1.setText(Integer.toString(profesion.getIdprof()));
           ...
           JOptionPane.showMessageDialog(null,"Campos clave vacíos","ATENCIÓN",JOptionPane.INFORMATION_MESSAGE);
            ...
            if (encontrado){  //si se encontro y se desea EDITAR
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    // try {
                    //si se presiono SI
                    pro=profges.GetObjProfesion();
                    pro.setDescripprof(jTextField2.getText().toUpperCase());
                    resu=profges.editProfesion(pro);
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    //  try {
                    pro.setIdprof(Integer.parseInt(jTextField1.getText()));
                    pro.setDescripprof(jTextField2.getText().toUpperCase());
                    resu=profges.addProfesion(pro);
                    if (resu){
            ...
            if (x==1){  //si se llevo a cabo algun cambio
                ...
                consulta=Sesion.createQuery("from Profesion order by descripprof");
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        if (encontrado && jTextField1.getText().isEmpty()==false){
            ...
            if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                //  try {
                if (clieges.ExisteFKProfesion(Integer.parseInt(jTextField1.getText()))==false){  //si no esta como FK en ninguna de las tablas
                    Profesion pro=new Profesion();
                    pro=profges.GetObjProfesion();
                    resu=profges.delProfesion(pro);
                    if (resu){  //SI SE EDITO CORRECTAMENTE
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmProfesion dialog = new FrmProfesion(new javax.swing.JFrame(), true);
