...
public class FrmEmpresa extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 153)), "Datos de la Empresa", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 153))); // NOI18N
        ...
        jTextField1.setToolTipText("CÓDIGO DE LA EMPRESA");
        ...
        jTextField2.setToolTipText("DESCRIPCIÓN DE LA EMPRESA");
        ...
        jLabel3.setText("Nº Tel.:");

        jTextField3.setToolTipText("NÚMERO DE TELÉFONO DE LA EMPRESA");
        ...
        jTextField4.setToolTipText("DIRECCIÓN  DE LA EMPRESA");
        ...
        jTextField5.setToolTipText("DIRECCIÓN  DE LA EMPRESA");
 ...
 //para el navegador de busqueda//
        ...
        EmpresaGest empges=new EmpresaGest();  //instanciamos las clases necesarias a lo largo del programa
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(milista.isEmpty()==false){  //si no esta vacia la lista, es decir si hay algun registro en la tabla
            contador=1;
            emp=(Empresa) (milista.get(contador-1));
            jTextField1.setText(Integer.toString(emp.getIdempresa()));
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        if(jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty()){ //si el campo id o descripcion estan vacios
            ...
            encontrado=false;
                ...
                encontrado=empges.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
                int r=0;
                boolean resu=false;
                if (encontrado){  //si se encontro y se desea EDITAR
                    ...
                    if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                        // try {
                        //si se presiono SI
                        em=empges.GetObjEmpresa();
                        em.setDescri(jTextField2.getText().toUpperCase());
                        em.setTelef(jTextField3.getText().toUpperCase());
                        em.setDirec(jTextField4.getText().toUpperCase());
                        em.setRuc(jTextField5.getText().toUpperCase());
                        resu=this.empges.editEmpresa(em);
                    ...
                    if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                        //  try {
                        em.setIdempresa(Integer.parseInt(jTextField1.getText()));
                        em.setDescri(jTextField2.getText().toUpperCase());
                        em.setTelef(jTextField3.getText().toUpperCase());
                        em.setDirec(jTextField4.getText().toUpperCase());
                        em.setRuc(jTextField5.getText().toUpperCase());
                        resu=this.empges.addEmpresa(em);
                        if (resu){
                ...
                if (x==1){  //si se llevo a cabo algun cambio
                    ...
                    consulta=Sesion.createQuery("from Empresa order by descri");
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        if (encontrado && jTextField1.getText().isEmpty()==false){
            ...
            if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    //  try {
                    if (clieges.ExisteFKEmpresa(Integer.parseInt(jTextField1.getText()))==false){  //si no esta como FK en ninguna de las tablas
                        Empresa em=new Empresa();
                        em=empges.GetObjEmpresa();
                        resu=empges.delEmpresa(em);
                        if (resu){  //SI SE EDITO CORRECTAMENTE
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        ...
        if(jTextField1.getText().isEmpty()==false){
            encontrado=empges.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
            if(encontrado){
                this.emp=empges.GetObjEmpresa();
                jTextField1.setText(Integer.toString(emp.getIdempresa()));
                jTextField2.setText(emp.getDescri());
                jTextField3.setText(emp.getTelef());
                jTextField4.setText(emp.getDirec());
                jTextField5.setText(emp.getRuc());
            } else {
