...
public class FrmUnidadMedida extends javax.swing.JDialog {

    /** Creates new form FrmUnidadMedida */
    public FrmUnidadMedida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(milista.isEmpty()==false){  //si no esta vacia la lista, es decir si hay algun registro en la tabla
            contador=1;
            um=(Unidadmedida) (milista.get(contador-1));
            jTextField1.setText(Integer.toString(um.getIdum()));
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        ...
        if(jTextField1.getText().isEmpty()==false){
            encontrado=umges.ExisteIdEnTabla(Integer.parseInt(jTextField1.getText()));
            if(encontrado){
                this.um=umges.GetObjUnidadmedida();
                jTextField1.setText(Integer.toString(um.getIdum()));
                jTextField2.setText(um.getDescripum());
            } else {
        ...
        if(jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty()){ //si el campo id o descripcion estan vacios
            ...
            if (encontrado){  //si se encontro y se desea EDITAR
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    // try {
                    //si se presiono SI
                    um=umges.GetObjUnidadmedida();
                    um.setDescripum(jTextField2.getText().toUpperCase());
                    resu=umges.editUnidadmedida(um);
                ...
                if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                    //  try {
                    um.setIdum(Integer.parseInt(jTextField1.getText()));
                    um.setDescripum(jTextField2.getText().toUpperCase());
                    resu=umges.addUnidadmedida(um);
                    if (resu){
            ...
            if (x==1){  //si se llevo a cabo algun cambio
                ...
                consulta=Sesion.createQuery("from Unidadmedida");
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        if (encontrado && jTextField1.getText().isEmpty()==false){
            ...
            if (r==JOptionPane.YES_OPTION){ //si se presiono SI
                //  try {
                if (stoges.ExisteFKUnidadMedida(Integer.parseInt(jTextField1.getText()))==false){  //si no esta como FK en ninguna de las tablas
                    Unidadmedida um=new Unidadmedida();
                    um=umges.GetObjUnidadmedida();
                    resu=umges.delUnidadmedida(um);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmUnidadMedida dialog = new FrmUnidadMedida(new javax.swing.JFrame(), true);
