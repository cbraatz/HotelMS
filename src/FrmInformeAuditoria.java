...
public class FrmInformeAuditoria extends javax.swing.JDialog {

    /** Creates new form FrmInformeAuditoria */
    public FrmInformeAuditoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Auditoría de Stock y Servicios");
        ...
        jRadioButton2.setText("Auditoría de Multas");
        ...
        jRadioButton5.setText("Auditoría de Moneda y Cotización");
        ...
        jRadioButton6.setText("Auditoría de Reservas");
        ...
        jRadioButton7.setText("Auditoría de Movimientos de Caja");
        ...
        jLabel26.setText("Por Operación:");
        ...
        jRadioButton8.setText("Auditoría de Apertura y cierre de Caja");
        ...
        jRadioButton3.setText("Inserción");
        ...
        jRadioButton4.setText("Actualización");

        jRadioButton9.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup2.add(jRadioButton9);
        jRadioButton9.setFont(new java.awt.Font("Trebuchet MS", 0, 14));
        jRadioButton9.setForeground(new java.awt.Color(0, 0, 204));
        jRadioButton9.setText("Borrado");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(this.jRadioButton1.isSelected() && this.jFormattedTextField1.getText().equals("  /  /    ")==false && this.jFormattedTextField2.getText().equals("  /  /    ")==false){
            ...
            String ope="ACTUALIZACIÓN";
            String tit="Auditoría (Actualización) de Stock y Servicios entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();
            if(this.jRadioButton3.isSelected()){
                ope="INSERCIÓN";
                tit="Auditoría (Inserción) de Stock y Servicios entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();
            }else{
                if(this.jRadioButton9.isSelected()){
                    ope="BORRADO";
                    tit="Auditoría (Borrado) de Stock y Servicios entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();
                }
            ...
            param.put("titulo",tit);
            if(this.jRadioButton4.isSelected()){
                cr.MostrarReporte("RepoAudiStockUp", "Informe de Auditoría de Stock y Servicios",param);
            }else{
                param.put("opera", ope);
                cr.MostrarReporte("RepoAudiStockAddDel", "Informe de Auditoría de Stock y Servicios",param);
        ...
        if(this.jRadioButton2.isSelected() && this.jFormattedTextField1.getText().equals("  /  /    ")==false && this.jFormattedTextField2.getText().equals("  /  /    ")==false){
            Map param = new HashMap();
            String ope="ACTUALIZACIÓN";
            String tit="Auditoría (Actualización) de Multas entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();
            if(this.jRadioButton3.isSelected()){
                ope="INSERCIÓN";
                tit="Auditoría (Inserción) de Multas entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();
            }else{
                if(this.jRadioButton9.isSelected()){
                    ope="BORRADO";
                    tit="Auditoría (Borrado) de Multas entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();
                }
            ...
            param.put("titulo",tit);
            if(this.jRadioButton4.isSelected()){
                cr.MostrarReporte("RepoAudiMulUp", "Informe de Auditoría de Multas",param);
            }else{
                param.put("opera", ope);
                cr.MostrarReporte("RepoAudiMulAddDel", "Informe de Auditoría de Multas",param);
        ...
        if(this.jRadioButton5.isSelected() && this.jFormattedTextField1.getText().equals("  /  /    ")==false && this.jFormattedTextField2.getText().equals("  /  /    ")==false){
            Map param = new HashMap();
            String ope="ACTUALIZACIÓN";
            String tit="Auditoría (Actualización) de Cotización de Monedas entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();
            if(this.jRadioButton3.isSelected()){
                ope="INSERCIÓN";
                tit="Auditoría (Inserción) de Cotización de Monedas entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();
            }else{
                if(this.jRadioButton9.isSelected()){
                    ope="BORRADO";
                    tit="Auditoría (Borrado) de Cotización de Monedas entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();
                }
            ...
            param.put("titulo",tit);
            if(this.jRadioButton4.isSelected()){
                cr.MostrarReporte("RepoAudiMonUp", "Informe de Auditoría de Cotización de Monedas",param);
            }else{
                param.put("opera", ope);
                cr.MostrarReporte("RepoAudiMonAddDel", "Informe de Auditoría de Cotización de Monedas",param);
        ...
        if(this.jRadioButton6.isSelected() && this.jFormattedTextField1.getText().equals("  /  /    ")==false && this.jFormattedTextField2.getText().equals("  /  /    ")==false){
            Map param = new HashMap();
            String tit="Auditoría de Reservas hechas entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();

            param.put("fecha1",cluti.FormatearFecha(this.jFormattedTextField1.getText()));
            param.put("fecha2",cluti.FormatearFecha(this.jFormattedTextField2.getText()));
            param.put("titulo",tit);
            cr.MostrarReporte("RepoAudiRes", "Informe de Reservas",param);
        }
        /////////////////////auditoria mov caja//////////////////////
        if(this.jRadioButton7.isSelected() && this.jFormattedTextField1.getText().equals("  /  /    ")==false && this.jFormattedTextField2.getText().equals("  /  /    ")==false){
            Map param = new HashMap();
            String tit="Auditoría de Movimientos de Caja entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();

            param.put("fecha1",cluti.FormatearFecha(this.jFormattedTextField1.getText()));
            param.put("fecha2",cluti.FormatearFecha(this.jFormattedTextField2.getText()));
            param.put("titulo",tit);
            cr.MostrarReporte("RepoAudiCaja", "Informe de Auditoría de Movimientos de Caja",param);
        }
        /////////////////////auditoria APERTURA Y CIERRE DE CAJA//////////////////////
        if(this.jRadioButton8.isSelected() && this.jFormattedTextField1.getText().equals("  /  /    ")==false && this.jFormattedTextField2.getText().equals("  /  /    ")==false){
            Map param = new HashMap();
            String tit="Auditoría de Aperturas y Cierres de Caja entre "+this.jFormattedTextField1.getText()+" y "+this.jFormattedTextField2.getText();

            param.put("fecha1",cluti.FormatearFecha(this.jFormattedTextField1.getText()));
            param.put("fecha2",cluti.FormatearFecha(this.jFormattedTextField2.getText()));
            param.put("titulo",tit);
            cr.MostrarReporte("RepoAudiApeYCieCaja", "Informe de Aperturas y Cierres de Caja",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmInformeAuditoria dialog = new FrmInformeAuditoria(new javax.swing.JFrame(), true);
